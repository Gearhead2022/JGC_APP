...
<div class="content-wrapper">
   <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-12">
          <h4 class="page-title">BLACKLISTED ACCOUNTS</h4>
        </div>
     </div>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-header float-sm-right">
              <div class="row">
                <?php if($_SESSION['type']=="admin" || $_SESSION['type']=="pdr_admin" ){?>
                  <button type="button" class="btn btn-light btn-round waves-effect waves-light m-1" onClick="location.href='blacklistadd'"><i class="fa fa-plus"></i> <span>&nbsp;ADD ACCOUNT</span> </button>
              <?php  }?>
            ...
            <div class="card-body">
              ...
              <table id="default-datatable" class="table table-bordered table-hover table-striped blacklistTable">
                <thead>
                <tr>
                  <th>Last Name</th>
                  <th>Middle Name</th>
...
<?php
  $deleteBlacklist = new ControllerBlacklist();
  $deleteBlacklist  -> ctrDeleteBlacklist();
  $changeProfile = new ControllerBlacklist();
  $changeProfile  -> ctrChangeProfile();
?>