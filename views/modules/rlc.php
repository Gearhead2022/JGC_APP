...
<div class="content-wrapper">
   <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-12">
          <h4 class="page-title">RLC ACCOUNTS</h4>
        </div>
     </div>
          ...
          <div class="card">
            <div class="card-header float-sm-right">
              ...
              <?php if($_SESSION['type']=="admin" || $_SESSION['type']=="hr_admin" || $_SESSION['type']=="hr_user"  ){?>
                <button type="button" id="rlc_add" class="btn btn-light waves-effect waves-light m-1" ><i class="fa fa-plus"></i> <span>&nbsp;ADD ACCOUNT</span> </button>
                  <button type="button" id="btn_rlc" class="btn btn-light waves-effect waves-light m-1" ><i class="fa fa-print"></i> <span>&nbsp;REPORTS</span> </button>
              <?php  }?>
            ...
            <div class="card-body">
              ...
              <table id="default-datatable"  class="table table-bordered table-hover table-striped rlcTable">
                <thead>
                <tr>
                  <th>ID NO.</th>
                  <th>First Name</th>
...
<?php
  $deleteRlc = new ControllerRlc ();
  $deleteRlc  -> ctrDeleteRlc ();
?>