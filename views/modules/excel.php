...
<head>
    ...
    <style>
        ...
        .spreadsheet h6, p, textarea, select#est_life_year, select#est_life_year, input#status, select#type,
        ...
        @media print {
            ...
            select.spreadsheet-cell, input#acq_cost, input#acc_depr,input#status, #hideHeader,
...
<body>
        ...
        <div class="container-fluid container-fixed-width">
            <div class="row mb-3 mt-2">
                ...
                <button class="btn btn-dark text-light btn-round waves-effect btn-custom-print me-2" data-bs-toggle="modal" data-bs-target="#addItemModal"><span><i class="fa fa-plus-circle"></i> &nbsp;Add Item</span></button>
                    ...
                    <button class="btn btn-success btn-round waves-effect btn-custom-print" data-bs-toggle="modal" data-bs-target="#addCorrespondentModal"><span><i class="fa fa-print"></i> &nbsp;Print</span></button>
                </div>
            </div>
            <div class="spreadsheet">
                <div class="row g-0">
                    ...
                    <div class="header-cell" id="hideHeader">
                        <h6>TYPE</h6>
                    </div>
                    <div class="header-cell" id="hideHeader">
                        <h6>STATUS</h6>
                    ...
                    foreach ($get_item_code as $code){
                        ...
                        foreach ($get_inventory_list as $inv) {
                            ...
                            if ($last_item_desc != $item_desc) {
                                ...
                                ?>
                                <input type="text" name="branch_name" id="branch_name"  hidden value="<?php echo $branch_name ?> ">
                                <div class="row g-0">
                                    ...
                                    <div class="input-cell">
                                        <input type="text" class="spreadsheet-cell" id="status" name="status" value="<?php echo $status; ?> ">
                                    </div>
                                </div>        
            ...
            <div class="extended-cell">
                <div class="row mt-2">
                    <div class="col-4" style="margin-left: -10px;">PREPARED & CERTIFIED BY:</div>
                </div>
                <div class="row">
                    <div class="col-1" style="border-bottom: 1px solid black;">
                    <input type="text" name="" id="note" class="note" placeholder="">
                    </div>
                </div>
                <div class="row">
                    <div class="col-1">
                        <input type="text" name="" id="printPreparedBy" class="note text-dark" placeholder="N/A">
                    </div>
                </div>
                <div class="row">
                    <div class="col-1">
                        <input type="text" name="" id="printPosition" class="note text-dark" placeholder="Position">
                    </div>
                </div>
        </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-12 form-group">
                                <label for="input-6">PREPARED & CERTIFIED BY:</label>
                                <input type="text" class="form-control" placeholder="Provide Name" id="preparedBy" name="preparedBy">
                            </div>
                            <div class="col-sm-12 form-group">
                                <label for="input-6">POSITION: </label>
                                <input type="text" class="form-control" id="position" placeholder="Provide Position">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                            <button type="button" id="printScreen" class="btn btn-primary printScreen">PRINT</button>
    ...
    <script>
        $(".printScreen").on('click', function() {
            ...
            // Ensure the element exists and is an input field
            var printPreparedBy = document.getElementById('printPreparedBy');
            var printPosition = document.getElementById('printPosition');

            $('#addCorrespondentModal').modal('hide');

            if (printPreparedBy && printPosition) {
                printPreparedBy.value = preparedBy;
                printPosition.value = position;
            }
