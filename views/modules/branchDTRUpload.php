...
<div class="content-wrapper">
   <div class="container-fluid">
     <div class="row pt-2 pb-2">
        <div class="col-sm-12">
          <h4 class="page-title">DTR FILE UPLOAD</h4>
        </div>
     </div>
      ...
      <div class="row">
          ...
          <div class="card">
            ...
            <div class="row">
                ...
                <div class="col-sm-2 form-group mt-4">
                  <button type="button" class="btn btn-light btn-round waves-effect waves-light m-1" onClick="location.href='branchTimeInDTRUpload'"><i class="fa fa-book"></i> <span>&nbsp;UPLOAD TIME-IN PAGE</span> </button>
                </div>
                <div class="col-sm-2 form-group mt-4 ml-3">
                  <button type="button" name="" class="btn btn-primary btn-round waves-effect waves-light m-1" data-toggle="modal" data-target="#uploadModal"><i class="fa fa-upload"></i> <span>&nbsp;UPLOAD DTR FILE</span> </button>
                </div>
              </div>           
            <div class="card-body">   
                <div class="row">  
                <hr />
                    ...
                    <table id="default-datatable" class="table table-bordered table-hover table-striped branchDailyDTRUploadTable">
                        <thead>
                        <tr>
                        <th>Actions</th>
                        <th>Branch Name</th>
        ...
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">UPLOAD DTR FILE</h5>
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="submit" name ="adddtr" class="btn btn-primary">Submit</button>
                    <button type="button"  class="btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
            </div>
            </form>
              <?php
                    $branch_DTR -> ctrAddBranchDailyDTRUpload();
                ?>
        </div>
        </div>
        <!--END Upload Modal -->
        ...
        <!-- EDIT DTR MODAL -->
        <div class="modal fade" id="editDTR" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-md" role="document">
              <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLongTitle">EDIT DTR FILE</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
              </div>
              ...
              <div class="modal-footer">
                  <button type="submit" name ="editdtr" class="btn btn-primary">Submit</button>
                  <button type="button"  class="btn btn-secondary" data-dismiss="modal">Close</button>
              </div>
              </form>
              <?php
                    $branch_DTR -> ctrEditBranchDailyDTRUpload();
                ?>
              </div> 
          </div>
        </div>
        <!-- END EDIT DTR MODAL -->  
         ...
         <!-- VIEW DTR MODAL -->
         <div class="modal fade" id="viewDTR" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered modal-md" role="document">
              <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLongTitle">VIEW DTR FILE INFO</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                  </button>
              </div>
...
<?php
  ...
  $branch_DTR  -> ctrDeleteBranchDailyDTRUpload();
