        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-header float-sm-right">
              <div class="row">
                <?php if($_SESSION['type']=="wp_user" || $_SESSION['type']=="wp_admin"){?>
                  <button type="button" class="btn btn-light btn-round waves-effect waves-light m-1" onClick="location.href='requestadd'"><i class="fa fa-plus"></i> <span>&nbsp;ADD REQUEST</span> </button>
              <?php  }?>
            ...
            <div class="card-body">
              ...
              <table id="default-datatable" class="table table-bordered table-hover table-striped requestTable">
                <thead>
                <tr>
                  <th>REFERENCE NO.</th>
                  <th>REQUESTED BY</th>
...
<?php
  $deleteRequest = new ControllerRequest();
  $deleteRequest  -> ctrDeleteRequest();
?>