...
public function getClientsPrinting_2(){
    ...
    // set margins
    $pdf->SetMargins(3 , 18, PDF_MARGIN_RIGHT);
    ...
    $img_file = K_PATH_IMAGES.'template15.jpg';
    $pdf->Image($img_file, 0, 0, 205, 142, '', '', '', false, 300, '', false, false, 0);
    ...
    <tr style="line-height: 58px;">
        ...
        <td style="width:25px; font-size:8px;"></td>
    ...
    <tr style="line-height: 25px;">
        ...
        <td style="width:65px; font-size:12px; text-align: right; line-height: 8px;">$amount</td> 
    </tr>
    <tr style="line-height: 1px;">
        <th style="width:20px; "></th> 
        <td style="width:270px; font-size:12px; ">$name</td>
        <td style="width:320px; "></td> 
        <td style="width:65px; font-size:12px;  text-align: right; line-height: -15px;">0.00</td> 
    </tr>
    ...
    <tr style="line-height: -9px;">
        ...
        <td style="width:155px; font-size:12px; line-height: 15px; text-align: right;">$amount</td> 
        <th style="width:60px; font-size:12px; text-align: right;"></th> 
    </tr>
    EOF;
    ...
    if ($charLen <= 40) {
        ...
        $header .= <<<EOF
            ...
            <tr style="line-height: 10px;">
                ...
                <th style="width:270px; font-size:8px;"></th>
                <td style="width:320px; "></td> 
                <th style="width:65px; font-size:12px;  text-align: right; line-height: 15px;">$amount</th> 
            </tr>
        EOF;
