...
public function getClientsPrinting_2(){
    ...
    // set margins
    $pdf->SetMargins(7, 19, PDF_MARGIN_RIGHT);
    ...
    // $img_file = K_PATH_IMAGES.'template10.jpg';
    // $pdf->Image($img_file, 0, 0, 208, 114, '', '', '', false, 300, '', false, false, 0);
    ...
    <tr style="line-height: 68px;">
        <th style="width:320px; font-size:8px;"></th>
        <td style="width:35px; font-size:8px;"></td>
        <td style="width:250px; font-size:12px; ">&nbsp;$format_date_month&nbsp;&nbsp;&nbsp;&nbsp;$format_date_date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$format_date_year</td>  
    </tr>
    ...
    <tr style="line-height: 12px;">
        <th style="width:560px; "></th> 
        <td style="width:20px; "></td> 
        <td style="width:62px; font-size:12px; text-align: right;">$amount</td> 
    </tr>
    <tr style="line-height: 11px;">
        <th style="width:20px; "></th> 
        <td style="width:240px; font-size:12px; ">$name</td>
        <td style="width:320px; "></td> 
        <td style="width:62px; font-size:12px;  text-align: right;">0.00</td> 
    </tr>
    <tr style="line-height: 15px;">
        <th style="width:270px; font-size:8px;"></th>
        <td style="width:320px; "></td> 
        <td style="width:20px; "></td> 
        <td style="width:62px; font-size:12px;  text-align: right;"></td> 
    </tr>
    <tr style="line-height: 12px;">
        <th style="width:270px; font-size:8px;"></th>
    ...
    <tr style="line-height: 9px;">
        <th style="width:240px; font-size:8px;"></th>
        <td style="width:320px; "></td> 
        <td style="width:20px; "></td> 
        <th style="width:62px; font-size:12px; text-align: right;">$amount</th> 
    </tr>
    ...
    <tr style="line-height: -9px;">
        ...
        <td style="width:250px; font-size:12px; line-height: 16px;">$desc</td>
    ...
    if ($charLen <= 40) {
        ...
        $header .= <<<EOF
            ...
            <tr style="line-height: 10px;">
                ...
                <th style="width:240px; font-size:8px;"></th>
                <td style="width:320px; "></td> 
                <th style="width:62px; font-size:12px;  text-align: right; line-height: 16px;">$amount</th> 
            </tr>
        EOF;
    } else {
