...
public function getClientsPrinting_2(){
    ...
    $img_file = K_PATH_IMAGES.'m2.jpg';
    $pdf->Image($img_file, 0, 0, 194, 117, '', '', '', false, 300, '', false, false, 0);
    ...
    <tr style="line-height: 58px;">
        ...
        <td style="width:28px; font-size:8px;"></td>
        <td style="width:260px; font-size:12px; line-height: 36px; ">&nbsp;$format_date_month&nbsp;&nbsp;&nbsp;&nbsp;$format_date_date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$format_date_year</td>  
    </tr>

    <tr style="line-height: 25px;">
        <th style="width:590px; "></th> 
        <td style="width:20px; "></td> 
        <td style="width:65px; font-size:12px; text-align: right; line-height: 12px;">$amount</td> 
    </tr>
    <tr style="line-height: 1px;">
        <th style="width:20px; "></th> 
        <td style="width:270px; font-size:12px; ">$name</td>
        <td style="width:325px; "></td> 
        <td style="width:60px; font-size:12px;  text-align: right; line-height: -7px;">0.00</td> 
    </tr>
    ...
    if ($charLen <= 40) {
        ...
        $header .= <<<EOF
            ...
            <tr style="line-height: 10px;">
                ...
                <th style="width:270px; font-size:8px;"></th>
                <td style="width:320px; "></td> 
                <th style="width:65px; font-size:12px;  text-align: right; line-height: -6px;">$amount</th> 
            </tr>
        EOF;
