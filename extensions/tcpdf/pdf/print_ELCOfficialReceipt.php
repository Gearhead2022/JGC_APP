...
public function getClientsPrinting_2(){
    ...
    // set margins
    $pdf->SetMargins(-2, 15, PDF_MARGIN_RIGHT);
    ...
    $img_file = K_PATH_IMAGES.'template11.jpg';
    $pdf->Image($img_file, 0, 0, 208, 110, '', '', '', false, 300, '', false, false, 0);
    ...
    <tr style="line-height: 58px;">
        ...
        <td style="width:35px; font-size:8px;"></td>
        <td style="width:260px; font-size:12px; "></td>  
    </tr>
  
    <tr style="line-height: 39px;">
        <th style="width:130px; "></th> 
        <td style="width:220px; line-height: 15px;">$amount</td> 
        <td style="width:350px; font-size:12px; text-align: right;">&nbsp;$format_date_month&nbsp;&nbsp;&nbsp;&nbsp;$format_date_date,&nbsp;&nbsp;&nbsp;$format_date_year</td> 
    </tr>
    <tr style="line-height: 11px;">
        <th style="width:130px; "></th> 
        <td style="width:250px;  line-height: -14px;">$amount</td>
        <td style="width:200px; ">$name</td> 
        <td style="width:60px; font-size:12px;  text-align: right;"></td> 
    </tr>
    <tr style="line-height: 15px;">
        <th style="width:130px; font-size:8px;"></th>
        <td style="width:460px; ">$amount</td> 
    ...
    <tr style="line-height: -9px;">
        ...
        <td style="width:295px; font-size:12px; line-height: 16px;"></td>
        <td style="width:370px; font-size:12px; line-height: 12px; text-align: right;">$amtwrd</td> 
    ...
    <tr style="line-height: 20px;">
        ...
        <th style="width:65px; font-size:12px;  text-align: right; line-height: 16px;">$amount</th> 
    </tr>
    <tr style="line-height: 50px;">
        <th style="width:20px; "></th> 
        <td style="width:360px; font-size:8px;"></td>
        <td style="width:310px; font-size:12px; line-height: 25px;">$desc</th> 
