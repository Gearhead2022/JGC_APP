...
<h4>EMB, FCH, RLC, & ELC <span style="text-align:center; font-style:italic; padding-left: 50px;"> "FULLY PAID RATE"</span> <br><span style="font-size: 8.5rem;">Fully Paid & Returnee For ($Fmonth)</span></h4>
<table>
...
$header .= <<<EOF
    ...
    $header .= <<<EOF
        ...
        for ($i=0; $i <count($dateArray) ; $i++) { 
                ...
                $getReturnee = $Operation->crtGetAllFullyPaid($branch_name, $firstDay, $lastDay);
                $below70 = 0;
                $above71 = 0;
