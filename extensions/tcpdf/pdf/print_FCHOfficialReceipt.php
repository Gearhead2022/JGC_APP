...
public function getClientsPrinting_2(){
    ...
    <tr style="line-height: 68px;">
        ...
        <td style="width:260px;  ">$format_date_month&nbsp;&nbsp;$format_date_date&nbsp;&nbsp;&nbsp;&nbsp;$format_date_year</td>  
    </tr>
    ...
    <tr style="line-height: -9px;">
        ...
        <td style="width:268px;  line-height: 16px;">$desc</td>
        <td style="width:155px; line-height: 12px; text-align: right;"><b>$amount</b></td> 
        <th style="width:60px; font-size:12px; text-align: right;"></th> 
    </tr>
