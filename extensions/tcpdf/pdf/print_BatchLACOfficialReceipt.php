...
public function getClientsPrinting_2(){
    ...
    // set margins
    $pdf->SetMargins(3 , 14, PDF_MARGIN_RIGHT);
    ...
    foreach ($data as &$item) {
        ...
        <tr style="line-height: 25px;">
            ...
            <td style="width:60px; font-size:12px; text-align: right;">$amount</td> 
        </tr>
        ...
        <tr style="line-height: 9px;">
            ...
            <td style="width:320px; "></td> 
            <td style="width:20px; "></td> 
            <th style="width:60px; font-size:12px; text-align: right;">$amount</th> 
        </tr>
        ...
        if ($charLen <= 40) {
            ...
            $header .= <<<EOF
                ...
                <tr style="line-height: 10px;">
                    ...
                    <th style="width:270px; font-size:8px;"></th>
                    <td style="width:320px; "></td> 
                    <th style="width:60px; font-size:12px;  text-align: right; line-height: 16px;">$amount</th> 
                </tr>
            EOF;
