...
public function getClientsPrinting_2(){
    ...
    // set margins
    $pdf->SetMargins(5 , 19, PDF_MARGIN_RIGHT);
    ...
    // $img_file = K_PATH_IMAGES.'OR.jpg';
    // $pdf->Image($img_file, 0, 0, 217, 115, '', '', '', false, 300, '', false, false, 0);
    ...
    foreach ($data as &$item) {
        ...
        // $desc = 'hsjdhjkhdjssdasdsadsadsadsadsadsadsadsadsdsdsasdasdsadsaasdasdsadsadsa';
    }
    ...
    <tr style="line-height: 45px;">
        <th style="width:330px; font-size:8px;"></th>
        <td style="width:55px; font-size:8px;"></td>
        <td style="width:260px; font-size:12px; line-height: 25px; ">&nbsp;$format_date_month&nbsp;&nbsp;&nbsp;&nbsp;$format_date_date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$format_date_year</td>  
    </tr>
    ...
    <tr style="line-height: 1px;">
        ...
        <td style="width:260px; font-size:12px; ">$name</td>
        <td style="width:320px; "></td> 
        <td style="width:65px; font-size:12px;  text-align: right;">0.00</td> 
    </tr>
    ...
    <tr style="line-height: 2px;">
        <th style="width:250px; font-size:8px;"></th>
    ...
    <tr style="line-height: -9px;">
        ...
        <td style="width:265px; font-size:12px; line-height: 20px;">$desc</td>
        <td style="width:155px; font-size:12px; line-height: 20px; text-align: right;">$amount</td> 
        <th style="width:60px; font-size:12px; text-align: right;"></th> 
    </tr>
    EOF;
    ...
    if ($charLen <= 40) {
        ...
        $header .= <<<EOF
            ...
            <tr style="line-height: 10px;">
                ...
                <th style="width:260px; font-size:8px;"></th>
                <td style="width:320px; "></td> 
                <th style="width:65px; font-size:12px;  text-align: right; line-height: -12px;">$amount</th> 
            </tr>
        EOF;
        ...
        $header .= <<<EOF
            ...
            <tr style="line-height: 10px;">
                ...
                <th style="width:260px; font-size:8px;"></th>
                <td style="width:320px; "></td> 
                <th style="width:65px; font-size:12px;  text-align: right; line-height: -52px;">$amount</th> 
            </tr>
        EOF;
