...
<tr>
EOF;
$conTicket = new ControllerTicket();
$html .= $table ;
$data = array(
  "id" => $penId,
...
$getAllTicket = $conTicket->ctrGetTickets($data);
$i = 0;
foreach($getAllTicket as $getTickets) { 
  ...
  $tickets = $getTickets['ticket_no'];
  $area_code = $getTickets['area_code'];
  if($area_code == "NORTH_NEG"){
    ...
    $html1 = <<<EOF
            ...
            <h5 style="font-size:12.6rem;background-color: lightgray; height: 1px;"><span style="color:lightgray;">s</span><br>$tickets<br><span style="color:lightgray;">sss</span></h5>
