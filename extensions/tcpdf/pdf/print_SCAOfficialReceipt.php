...
public function getClientsPrinting_2(){
    ...
    // set margins
    $pdf->SetMargins(1 , 16, PDF_MARGIN_RIGHT);
    ...
    // $img_file = K_PATH_IMAGES.'template16.jpg';
    // $pdf->Image($img_file, 0, 0, 192, 142, '', '', '', false, 300, '', false, false, 0);
    ...
    <tr style="line-height: 55px;">
        ...
        <td style="width:30px; font-size:8px;"></td>
        <td style="width:260px; font-size:12px; line-height: 30px; ">&nbsp;$format_date_month&nbsp;&nbsp;&nbsp;&nbsp;$format_date_date&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$format_date_year</td>  
    </tr>
