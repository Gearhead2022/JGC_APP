...
public function getClientsPrinting_2(){
    ...
    // set margins
    $pdf->SetMargins(0, 7, PDF_MARGIN_RIGHT);
    ...
    <tr style="line-height: -9px;">
        ...
        <td style="width:280px; font-size:12px; line-height: 16px;"></td>
        <td style="width:305px; font-size:12px; line-height: 12px; text-align: right;">$amtwrd</td> 
        <th style="width:60px; font-size:12px; text-align: right;"></th> 
    </tr>
