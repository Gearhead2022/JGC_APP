...
if($branch == "ALL" || $branch == ""){
    $ins = (new ControllerInsurance)->ctrShowFilterCBIInsurance($date);
}else{
    $ins = (new ControllerInsurance)->ctrShowFilterCBIInsuranceByBranch($date, $branch);
}
$total_amount=0;
...
$fileName = "CBI INSURANCE SUMMARY " . $date;
