...
$spreadsheet->getActiveSheet()->getStyle('A5:R5')->getFont()->setSize(11);
// Set horizontal alignment to center for range 'A5:R5'
$spreadsheet->getActiveSheet()->getStyle('A5:R5')->getAlignment()
    ->setHorizontal(Alignment::HORIZONTAL_CENTER)
    ->setVertical(Alignment::VERTICAL_CENTER);
$spreadsheet->getActiveSheet()->getStyle('A:R')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
...
for ($row = 5; $row <= 5; $row++) {
    $spreadsheet->getActiveSheet()->getStyle("A$row:R$row")->applyFromArray($borderStyle);
    $spreadsheet->getActiveSheet()->getStyle("A$row:R$row")->applyFromArray($fillStyle);
}
...
// Content 
$ins = (new ControllerInsurance)->ctrShowFilterInsuranceBranch($date, $branch_name);
if(!empty($ins)){
$row = 6;
$id = 1;
$total_amount=0;
...
$fileName = $branch_name . " INSURANCE " . $date;
